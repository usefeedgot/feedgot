...
export const brandingConfig = pgTable('branding_config', {
  ...
  // Theme settings
  theme: text('theme', { enum: ['light', 'dark', 'system', 'custom'] }).default('system'),
  ...
  // Layout preferences
  layoutStyle: text('layout_style', { enum: ['compact', 'comfortable', 'spacious'] }).default('comfortable'),
  sidebarPosition: text('sidebar_position', { enum: ['left', 'right'] }).default('left'),
...
export const brandingAsset = pgTable('branding_asset', {
  ...
  // Asset details
  name: text('name').notNull(),
  type: text('type', { enum: ['logo', 'favicon', 'background', 'icon', 'other'] }).notNull(),
